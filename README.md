...
Task was to develop an algorithm for sorting poker hands according to their strength.

### Poker Games

Solution support three poker game types:
...
Solution implemented in the `process` method in the [main.py](solver/main.py) file.

All the unit tests in [texas_holdem_solver_test.py](test/texas_holdem_solver_test.py), [omaha_holdem_solver_test.py](test/omaha_holdem_solver_test.py), 
and [five_card_draw_solver_test.py](test/five_card_draw_solver_test.py) passed and also added new tests.
